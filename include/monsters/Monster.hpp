...
class Monster {
    ...
    public: void take_damage(const Monster& attacker, const Move& move);

    public: void set_moves(string move_name, char type, int power, char category);

    public: int get_percentage() const;
